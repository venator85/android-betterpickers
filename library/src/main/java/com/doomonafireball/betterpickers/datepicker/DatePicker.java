...
public class DatePicker extends LinearLayout implements Button.OnClickListener,
    ...
    public static final char DateFormat_MONTH = 'M';
    public static final char DateFormat_DATE = 'd';
    public static final char DateFormat_YEAR = 'y';
    ...
    private class KeyboardPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup collection, int position) {
            ...
            if (mDateFormatOrder[position] == DateFormat_MONTH) {
                // Months
            ...
            } else if (mDateFormatOrder[position] == DateFormat_DATE) {
                // Date
            ...
            } else if (mDateFormatOrder[position] == DateFormat_YEAR) {
                // Year
    ...
    public void setDate(int year, int monthOfYear, int dayOfMonth) {
        ...
        for (int i = 0; i < mDateFormatOrder.length; i++) {
            ...
            if (c == DateFormat_MONTH && monthOfYear == -1) {
                mKeyboardPager.setCurrentItem(i, true);
                break;
            } else if (c == DateFormat_DATE && dayOfMonth <= 0) {
                mKeyboardPager.setCurrentItem(i, true);
                break;
            } else if (c == DateFormat_YEAR && year <= 0) {
                mKeyboardPager.setCurrentItem(i, true);
                break;
            }
        }
